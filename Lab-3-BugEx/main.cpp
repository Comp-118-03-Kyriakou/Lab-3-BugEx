...
int main() {
    ...
    int quantity[SIZE], total[SIZE]{0};
    ...
    do {
        ...
        switch (choice){
            ...
            // Exit
            case 4:
                cout<<"\nSum of all numbers."<<sumOddArray(quantity,SIZE)<<endl;
                break;
            case 5:
                if(isAllPositive(quantity,SIZE))
                    cout<<"\nAll numbers are positive."<<endl;
                else
                    cout<<"\nNot all numberss are positive."<<endl;
                break;
            case 6:
                int avgOdd;
                avgOddArray(quantity,SIZE,avgOdd);
                cout<<"\nAverage of odd numbers."<<avgOdd<<endl;
                break;
            case 7://No Code Needed
                break;
            default:
                assert(true);
        }
